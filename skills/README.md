...
| [modernize-abap-to-btp-cap](modernize-abap-to-btp-cap/SKILL.md) | End-to-end orchestrator from a classic ABAP Z* package to a side-by-side BTP CAP application: architecture contract, runtime-neutral staging, conditional schema/service/UI work, CAP tests, then exactly one CF or Kyma delivery branch | "Port this Z package to BTP CAP"; the `extract_to_side_by_side` arm of `sap-erp-clean-core-refactor` |
